        ...
        webView!!.apply {
            ...
            webChromeClient = object : WebChromeClient() {
                override fun onCreateWindow(
                    ...
                    val newWebView = WebView(this@ItemRegisterActivity).apply {
                        webViewClient = WebViewClient()
                        settings.javaScriptEnabled = true
                    }

                    val dialog = Dialog(this@ItemRegisterActivity).apply {
...
//            startActivityForResult(intentCamera, FILECHOOSER_LOLLIPOP_REQ_CODE)
    ...
    private inner class WebViewClientClass : WebViewClient() {
        ...
        override fun onReceivedSslError(
            ...
            val builder : AlertDialog.Builder = android.app.AlertDialog.Builder(this@ItemRegisterActivity)
