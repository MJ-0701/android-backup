        ...
        webView!!.apply {
            ...
            webChromeClient = object : WebChromeClient() {
                override fun onCreateWindow(
                    ...
                    val newWebView = WebView(this@NoteRegisterActivity).apply {
                        webViewClient = WebViewClient()
                        settings.javaScriptEnabled = true
                    }

                    val dialog = Dialog(this@NoteRegisterActivity).apply {
...
//            }
        ...
        override fun onReceivedSslError(
            ...
            val builder : AlertDialog.Builder = android.app.AlertDialog.Builder(this@NoteRegisterActivity)
